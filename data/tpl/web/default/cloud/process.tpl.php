...
<div class="clearfix js-processor">
	<?php  if(empty($packet['schemas'])) { ?>
		...
		<?php  if(!empty($packet['install'])) { ?>
			...
			<?php  } else { ?>
			<script>
				location.href = '<?php  echo url("module/manage-system/install", array("module_name" => $m, "flag" => 1, "account_type" => $_GPC["account_type"]));?>';
			</script>
			<?php  } ?>
		<?php  } ?>
		<!-- 升级 -->
		...
		<script>
			<?php  if($_GPC['batch']) { ?>
				location.href = '<?php  echo url("cloud/process", array("step" => "scripts", "m" => $m, "is_upgrade" => $is_upgrade, "batch" => 1, "account_type" => $_GPC["account_type"]));?>';
			<?php  } else { ?>
				location.href = '<?php  echo url("cloud/process", array("step" => "scripts", "m" => $m, "is_upgrade" => $is_upgrade, "account_type" => $_GPC["account_type"]));?>';
			<?php  } ?>
		</script>
		<?php  } ?>
...
<div class="clearfix js-processor">
	<?php  if(empty($packet['scripts']) || !empty($packet['type'])) { ?>
		...
		<?php  if($is_upgrade == 1) { ?>
			...
			<?php  } else { ?>
			<script>
				location.href = '<?php  echo url("module/manage-system/upgrade", array("module_name" => $m, "flag" => 1, "account_type" => $_GPC["account_type"]));?>';
			</script>
			<?php  } ?>
