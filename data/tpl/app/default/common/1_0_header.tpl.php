...
<head>
	...
	<script type="text/javascript" src="<?php  echo $_W['siteroot'];?>resource/js/app/util.js"></script>
	<script src="<?php  echo $_W['siteroot'];?>resource/js/require.js"></script>
	<script type="text/javascript" src="<?php  echo $_W['siteroot'];?>resource/js/lib/jquery-1.11.1.min.js?v=20170802"></script>
	<script type="text/javascript" src="<?php  echo $_W['siteroot'];?>resource/js/lib/mui.min.js?v=20170802"></script>
	<script type="text/javascript" src="<?php  echo $_W['siteroot'];?>resource/js/app/common.js?v=20170802"></script>
	<link href="<?php  echo $_W['siteroot'];?>resource/css/bootstrap.min.css?v=20170802" rel="stylesheet">
	<link href="<?php  echo $_W['siteroot'];?>resource/css/common.min.css?v=20170802" rel="stylesheet">
